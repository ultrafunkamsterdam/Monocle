...
[![Build Status](https://travis-ci.org/ZeChrales/Monocle.svg?branch=develop)](https://travis-ci.org/ZeChrales/Monocle)
...
2. `git clone --recursive https://github.com/ZeChrales/Monocle.git`
